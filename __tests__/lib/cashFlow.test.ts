...
describe('calculateCashFlow', () => {
    it('直接払いと共通口座支出に応じた入金額を計算する', () => {
        ...
        expect(summary.husbandTarget).toBe(159467);
        expect(summary.wifeTarget).toBe(139533);
        ...
        expect(summary.husbandSharedDeposit).toBe(69467);
        expect(summary.wifeSharedDeposit).toBe(119533);
    ...
    it('目標負担額を超えて直接払いした人への精算を計算する', () => {
        ...
        expect(summary.settlementAmount).toBe(40533);
