...
export const metadata: Metadata = {
    title: '家賃補助を受ける場合の考え方 | 家計負担割合計算アプリ',
    description: '家賃補助を受ける場合の、夫婦間の家計負担の考え方を解説します。',
};

export default function RentSubsidyExplanationPage() {
    return (
        <ExplanationArticle title="家賃補助を受ける場合の考え方">
